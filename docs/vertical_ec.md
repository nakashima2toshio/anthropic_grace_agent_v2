...
keyword-trap の誤爆抑止が最も効く業界でもある。7 つの機構への割り当ては次のとおり。
...
| 「**返金**ポリシーを教えて」 | 返金 | question | 誤爆抑止 → answer |
...
| keyword-trap | 2 | 返金ポリシーを教えて／解約手続きの流れを教えて | answer（誤爆・誤起票しない） |
