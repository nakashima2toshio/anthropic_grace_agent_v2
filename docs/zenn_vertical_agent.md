...
| 3 | [docs/vertical_gov.md](https://github.com/nakashima2toshio/anthropic_grace_agent_v2/blob/master/docs/vertical_gov.md) | **Gov・自治体プロファイル** — 唯一の厳格しきい値（0.8/0.5）・減免/不服 trap の誤爆抑止・e-Gov 法令 API 投入手順・KPI 7/7 |
